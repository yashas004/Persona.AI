    ...
    with tab1:
        ...
        if start_button:
            ...
            try:
                ...
                # Check if we have any facial data
                if len(facial_data) == 0:
                    st.error("No facial data was captured. Using default metrics.")
                    avg_facial_metrics = default_metrics
                else:
                    avg_facial_metrics = {
                ...
                st.info("Please make sure your webcam is properly connected and permissions are granted.")
